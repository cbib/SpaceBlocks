rule spatial_niches:
    ...
    params:
        ...
        niche_resolution=SPATIAL_NICHES.get("niche_resolution", 0.1),
        compute_umap=SPATIAL_NICHES.get("compute_umap", False),
        cluster_n_neighbours=SPATIAL_NICHES.get("cluster_n_neighbours", 50),
        n_iterations=SPATIAL_NICHES.get("n_iterations", -1),
